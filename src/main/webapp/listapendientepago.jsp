...
<div class="sidebar">
    <legend><i class="fas fa-file-invoice"></i> &nbsp; LISTA PAGOS PENDIENTES</legend>
    <div class="button-container">
        <button type="button" class="btn btn-raised btn-info btn-sm" onclick="location.href = 'factura_has_servicios.jsp'">Nueva Factura</button>
...
function cargarTabla() {
    $.ajax({
        data: {listar: 'listarPendiente'},
        url: 'jsp/pagocrud.jsp',
        type: 'post',
