        ...
        <fieldset>
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <legend><i class="fas fa-user-tag"></i> &nbsp; HUÉSPEDES</legend>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="hues_ci" class="bmd-label-floating">Cédula de Identidad</label>
                            <input type="text" class="form-control" id="hues_ci" name="hues_ci" maxlength="9" placeholder="Ej: 1.234.567">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="hues_telefono" class="bmd-label-floating">Teléfono</label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="eliminarHuespedModalLabel">Eliminar huésped</h5>
            ...
            <div class="modal-body">
                ...
                <p>¿Estás seguro/a que quieres eliminar a este huésped?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                <button type="button" class="btn btn-primary" id="eliminarRegistroHuesped" data-dismiss="modal">Sí</button>
            </div>
        </div>
    </div>
</div>
