...
<div class="sidebar">
    <legend><i class="fas fa-file-invoice"></i> &nbsp; COMPRAS</legend>
    <div class="button-container">
        
        <form action="informecompra.jsp" method="post" target="_blank">
            Fecha de inicio: <input type="date" name="fechaInicio" required>
            Fecha de fin: <input type="date" name="fechaFin" required>
            <input type="submit" value="Generar informe">
        </form>
        
        <button type="button" class="btn btn-raised btn-info btn-sm" onclick="location.href = 'detallecompras.jsp'">Nueva Compra</button>
